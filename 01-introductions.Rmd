...
- When everyone is ready, discuss the prompts below. One of you volunteer to record a few thoughts in [this Google Doc](https://docs.google.com/document/d/11COyuGq9ctW3va2utmcqM_HYtlaXspPUMwq1jiTw7W0/edit?usp=sharing). The instructor will summarize responses from all the sections to create a resource that everyone can use.
